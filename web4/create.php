<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($errorFlag == 0){
          ...
          $products->addChild('id', $_POST['id']);
          $products->addChild('name', $_POST['name']);
          $products->addChild('cost', $_POST['cost']);
          $products->addChild('describes', $_POST['describes']);
          $dom = new DomDocument();
          $dom->preserveWhiteSpace = false;
          $dom->formatOutput = true;
          $dom->loadXML($products->asXML());
          $dom->save('data/products.xml');
